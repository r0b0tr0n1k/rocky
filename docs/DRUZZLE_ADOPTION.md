...
```
packages/
├── @prasici/database/           ← renamed from db
│   ├── src/
...
│   └── package.json
│
├── @prasici/validators/         ← restructured
│   ├── src/
...
import { farmSelectSchema, farmInsertSchema } from "@prasici/database/zod";
