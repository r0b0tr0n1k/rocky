export const MOVEMENT_ERRORS = {
  ...
  EUDR_BREACHED: "MOVEMENT_EUDR_BREACHED",
  DISEASE_ZONE_BREACHED: "MOVEMENT_DISEASE_ZONE_BREACHED",
  TAG_REQUIRED_BEFORE_MOVE: "MOVEMENT_TAG_REQUIRED_BEFORE_MOVE",
  TRANSMISSION_DEADLINE_EXCEEDED: "MOVEMENT_TRANSMISSION_DEADLINE_EXCEEDED",
} as const;
