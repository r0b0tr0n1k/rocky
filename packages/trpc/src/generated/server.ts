...
const appRouter = t.router({
  ...
  document: t.router({
    ...
    credential: publicProcedure
      ...
      .query(async () => "PLACEHOLDER_DO_NOT_REMOVE" as any),
    credentialBatch: publicProcedure
      .input(credentialBatchRequestSchema)
      .output(credentialBatchResponseSchema)
      .mutation(async () => "PLACEHOLDER_DO_NOT_REMOVE" as any),
  ...
  earTag: t.router({
    ...
    getTakeoverFile: publicProcedure
      ...
      .query(async () => "PLACEHOLDER_DO_NOT_REMOVE" as any),
    replaceTag: publicProcedure
      .input(replaceTagRequestSchema)
      .output(replaceTagResponseSchema)
      .mutation(async () => "PLACEHOLDER_DO_NOT_REMOVE" as any)
    }),
  farmBook: t.router({
    getById: publicProcedure
  ...
  notification: t.router({
    unreadCount: publicProcedure
      ...
      .query(async () => "PLACEHOLDER_DO_NOT_REMOVE" as any),
    list: publicProcedure
      .input(notificationListRequestSchema)
      .output(z.array(notificationOutputSchema))
      .query(async () => "PLACEHOLDER_DO_NOT_REMOVE" as any),
    ...
    confirmDelivery: publicProcedure
      .input(confirmDeliverySchema.omit({ userId: true }))
      .output(notificationOutputSchema)
      .mutation(async () => "PLACEHOLDER_DO_NOT_REMOVE" as any),
    registerDevice: publicProcedure
