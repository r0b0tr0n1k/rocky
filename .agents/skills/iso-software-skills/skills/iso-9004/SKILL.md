---
name: iso-9004
description: "Managing for the sustained success of an organization - a quality management approach. Use when going beyond ISO 9001 requirements, building organizational maturity, or pursuing sustained success. Triggers: sustained success, ISO 9004, organizational maturity, self-assessment, innovation, balanced scorecard, key performance indicators, benchmarking, learning organization."
---
...
Establish & maintain "people development plan":
...
**6.4.1 General**
When developing partnerships, consider:
...
**6.7.1 General**
Establish & maintain processes to manage knowledge, information, technology as essential resources:

- Identify, obtain, maintain, protect, use, evaluate need
- Share with interested parties as appropriate

**6.7.2 Knowledge**
Assess how organization's current knowledge base is identified & protected:
...
**6.7.3 Information**
Establish & maintain processes to gather reliable/useful data & convert to information for decision making:
...
**6.7.4 Technology**
Consider technological options to enhance performance:
...
**8.3.1 General**
Assess progress against mission, vision, policies, strategies, objectives at all levels & functions.
...
**9.3.1 General**
Changes in environment may require innovation to meet needs & expectations.
...
**9.3.4 Process**
Establish, maintain, manage processes for innovation considering:
...
**9.3.5 Risks**
Assess risks related to planned innovation activities:
