...
| A.5.15 | Access control | Row-Level Security enforced via pgPolicy + the ExecutionPipeline RLSStage binds every query to the actor's farm/tenant scope; the geofence lockdown further restricts logical access on a positive lab result (ADR-0092). | **IMPLEMENTED** | packages/database (RLS policies); ADR-0006; packages/execution; ADR-0092; [ROCKY-FE-001](frontend-conformity.md) (frontend RBAC gating via usePermissions/useCan) |
| A.5.16 | Identity management | Better Auth resolves a canonical Principal (subject/role/admin) per session; identity is centralised, not per-app. | **IMPLEMENTED** | packages/auth; ADR-0021; [ROCKY-FE-001](frontend-conformity.md) (frontend session/identity surfacing) |
...
| A.5.18 | Access rights | Authorization Bot: Principal + PolicyRegistry + PolicyEngine evaluate action/role/admin at every router boundary. | **IMPLEMENTED** | packages/authorization; ADR-0022; [ROCKY-FE-001](frontend-conformity.md) (frontend permission gating) |
| A.5.19 | Information security in supplier relationships | Governance-layer control. The supplier/processor security-assessment procedure is now authored (ROCKY-SUP-001, ADR-0098); the processor register + DPA are the inventory/contract sources. | **PLANNED** | ADR-0067 Decision P2; [rocky-supplier-security-assessment.md](./rocky-supplier-security-assessment.md) (ROCKY-SUP-001, ADR-0098); [rocky-processor-register.md](./rocky-processor-register.md); [rocky-dpa.md](./rocky-dpa.md) |
...
| A.5.20 | Addressing information security within supplier agreements | Governance-layer control. Security within supplier agreements is specified by ROCKY-SUP-001 (ADR-0098) over the existing DPA (ROCKY-PROC-001). | **PLANNED** | ADR-0067 Decision P2; [rocky-supplier-security-assessment.md](./rocky-supplier-security-assessment.md) (ROCKY-SUP-001, ADR-0098); [rocky-dpa.md](./rocky-dpa.md) |
| A.5.21 | Managing information security in the information and communication technology (ICT) supply chain | Governance-layer control. ICT supply-chain security is specified by ROCKY-SUP-001 (ADR-0098), tiering suppliers by data sensitivity. | **PLANNED** | ADR-0067 Decision P2; [rocky-supplier-security-assessment.md](./rocky-supplier-security-assessment.md) (ROCKY-SUP-001, ADR-0098) |
...
| A.5.24 | Information security incident management planning and preparation | Governance-layer control. The incident response plan is now authored (ROCKY-IRP-001, ADR-0097) as the ISO wrapper; detection + evidence via the tamper-evident audit (ADR-0007). | **PLANNED** | ADR-0067 Decision P2; [rocky-incident-response-plan.md](./rocky-incident-response-plan.md) (ROCKY-IRP-001, ADR-0097); ADR-0007 |
| A.5.25 | Assessment and decision on information security events | Governance-layer control. Assessment/severity decision is specified in ROCKY-IRP-001 (ADR-0097); personal-data breach assessment owns ROCKY-BRCH-001 (ADR-0072). | **PLANNED** | ADR-0067 Decision P2; [rocky-incident-response-plan.md](./rocky-incident-response-plan.md) (ROCKY-IRP-001, ADR-0097); ADR-0072 |
| A.5.26 | Response to information security incidents | Governance-layer control. Contain → eradicate → recover is specified in ROCKY-IRP-001 (ADR-0097); GDPR breach response owns ROCKY-BRCH-001 (ADR-0072). | **PLANNED** | ADR-0067 Decision P2; [rocky-incident-response-plan.md](./rocky-incident-response-plan.md) (ROCKY-IRP-001, ADR-0097); ADR-0072 |
| A.5.27 | Learning from information security incidents | Governance-layer control. Post-incident review (the common gap) is mandated in ROCKY-IRP-001 (ADR-0097). | **PLANNED** | ADR-0067 Decision P2; [rocky-incident-response-plan.md](./rocky-incident-response-plan.md) (ROCKY-IRP-001, ADR-0097) |
...
| A.5.29 | Information security during disruption | Governance-layer control. The business continuity & ICT readiness plan is now authored (ROCKY-BCP-001, ADR-0099); the rebuild capability (scripts/db-recreate.sh) is the as-built evidence; RTO/RPO SLA is planned. | **PLANNED** | ADR-0067 Decision P2; [rocky-bcp-ict-readiness.md](./rocky-bcp-ict-readiness.md) (ROCKY-BCP-001, ADR-0099); scripts/db-recreate.sh |
...
| A.5.30 | ICT readiness for business continuity | Governance-layer control. ICT readiness is specified by ROCKY-BCP-001 (ADR-0099): version-controlled rebuild + tamper-evident audit preserve continuity; redundancy is planned. | **PLANNED** | ADR-0067 Decision P2; [rocky-bcp-ict-readiness.md](./rocky-bcp-ict-readiness.md) (ROCKY-BCP-001, ADR-0099) |
| A.5.31 | Legal, statutory, regulatory and contractual requirements | Governance-layer control. The in-scope legal/regulatory obligations (EU AHL Reg 2016/429, GDPR, MK LPDP) are enumerated in the obligation register [ROCKY-OBL-001](./rocky-obligation-register.md); the ISMS procedure to be issued per ADR-0067 Phase 2 (P2). | **PLANNED** | ADR-0054; ROCKY-OBL-001; ADR-0067 Decision P2 |
