...
1. **tRPC type surface** — `packages/trpc/src/generated/server.ts` (171 procedures as of 2026-07-12; was 155 on 2026-07-09) regenerated by
...
- `pnpm -C apps/api generate:trpc` regenerates; `apps/web` + `apps/mob` typecheck against 171 procedures (was 155).
