              ...
              dialog: (
                <RowDetailsDialog
                  ...
                  fields={[
                    ...
                    { label: "Assembled", value: row.original.assembledAt ? new Date(row.original.assembledAt).toLocaleDateString() : "—" },
                    { label: "Delivered", value: row.original.deliveredAt ? new Date(row.original.deliveredAt).toLocaleDateString() : "—" },
