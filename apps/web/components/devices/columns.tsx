...
export function deviceColumns(
  opts: DeviceColumnLookups & {
    ...
    registerFailedAttempt: {
      mutate: (v: z.input<typeof registerFailedAttemptDeviceRequestSchema>) => void;
      isPending: boolean;
    };
          ...
          },
          {
            ...
            dialog: (
              <ActionDialog
                ...
                defaultValues={{ deviceId: row.original.id }}
                fields={() => <p className="text-sm text-muted-foreground">Confirm logging a failed unlock attempt.</p>}
              />
            ),
          },
          {
            ...
            dialog: (
              <ActionDialog
                ...
                defaultValues={{ deviceId: row.original.id }}
                fields={() => <p className="text-sm text-muted-foreground">Confirm unblocking this device.</p>}
              />
            ),
          },
        ];
