      ...
      <CardContent className="gap-4 p-4">
        ...
        <FormField label="Test Type" error={errors.testType?.message} nativeID="testType">
          <Select
            ...
            onValueChange={(opt) => setValue("testType", (opt?.value ?? undefined) as testTypeType | undefined, { shouldValidate: true })}
          >
        ...
        <FormField label="Result" error={errors.result?.message} nativeID="result">
          <Select
            ...
            onValueChange={(opt) => setValue("result", (opt?.value ?? undefined) as testResultType | undefined, { shouldValidate: true })}
          >
