  ...
  return (
    ...
    <Card className="m-4">
      <CardContent className="gap-4 p-4">
        ...
        <FormField label="Vaccine ID" error={errors.vaccineId?.message} nativeID="vaccineId">
          <Input
            placeholder="UUID of the vaccine"
            value={watch("vaccineId")}
            onChangeText={(t) => setValue("vaccineId", t, { shouldValidate: true })}
          />
        </FormField>

        <FormField label="Batch ID" error={errors.batchId?.message} nativeID="batchId">
          <Input
            placeholder="UUID of the batch"
            value={watch("batchId")}
            onChangeText={(t) => setValue("batchId", t, { shouldValidate: true })}
          />
        </FormField>
        ...
        <FormField label="Administration Route" error={errors.route?.message} nativeID="route">
          <Select
            ...
            onValueChange={(opt) => setValue("route", (opt?.value ?? undefined) as administrationRouteType | undefined, { shouldValidate: true })}
          >
