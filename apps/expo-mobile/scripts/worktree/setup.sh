...
# Generate .env.worktree for this worktree
generate_worktree_env() {
    log_info "Generating .env.worktree for branch: $BRANCH"
    "$SCRIPT_DIR/../generate-worktree-env.sh" --name "$BRANCH"
    log_success "Generated .env.worktree"
}
